 ...
 * setup method annotated with the {@link org.junit.jupiter.api.BeforeAll} annotation is run and
 * after the teardown method annotated with the {@link org.junit.jupiter.api.AfterAll} annotation
 * has been run.
 *
 * Note that an extension which implements either the {@link AfterAllCallback} or the {@link
 * BeforeAllCallback}* interfaces must be registed at the class level. If this extensions is
 * registered at the method level, it's simply ignored by JUnit 5.
 */
